...
const ProductCard = ({ product, viewMode, userStatus, onViewDetails }) => {
  ...
  // ✅ FIX: Use totalStock instead of stock
      ...
      <Card className="w-full hover:shadow-lg transition-all bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <div className="hidden sm:flex gap-3 p-2.5 items-center">
          ...
          <div className="flex-1 flex flex-col justify-center min-w-0 overflow-hidden">
            ...
            {/* ✅ REMOVED SKU - Just show Pack Size */}
          ...
          <div className="flex gap-2.5 p-2.5">
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
              <div className='flex justify-between gap-2'>
                ...
                {product.isNewProduct && (
                  <Badge className="bg-gradient-to-r from-green-600 to-green-700 text-white border-0 text-[9px] px-1.5 py-0 h-4 flex-shrink-0">
                    <Sparkles className="w-2.5 h-2.5 mr-0.5" />
                    New
                  </Badge>
                )}
                <Badge variant="outline" className="bg-blue-50 dark:bg-blue-950 border-blue-300 dark:border-blue-700 text-blue-800 dark:text-blue-400 text-[9px] px-1.5 py-0 h-4 flex-shrink-0">
                  {product.category}
                </Badge>
              </div>
              {/* ✅ FIX: Use productName */}
