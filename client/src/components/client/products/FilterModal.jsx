...
// ✅ ADD: filterOptions prop
const FilterModal = ({ isOpen, onClose, filters, onFilterChange, onApply, filterOptions }) => {
  if (!isOpen) return null;

  return (
    <div className="fixed inset-0 z-50 lg:hidden">
      <div className="absolute inset-0 bg/50" onClick={onClose} />
